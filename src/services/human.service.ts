...
@injectable()
export class HumanService extends BaseCrudService<Human, number> implements IHumanService {
   ...
   * @param password
   */
  async humanLogin(username: string, password: string): Promise<LoginHumanResponseDto> {
